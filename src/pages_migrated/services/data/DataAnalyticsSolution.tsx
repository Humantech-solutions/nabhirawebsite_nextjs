  ...
  const methodology = [
    ...
    },
    {
      ...
      points: [
        ...
        "Predictive and scenario analysis models",
        "Executive dashboards and operational platforms",
    ...
    <>
      <ServiceHero
        title={renderHeroTitle(heroData?.heroS1Title || (
          <>Transform Data into <br /> <span className="text-[#f99d1c]">Strategic Advantage.</span></>
        ))}
        description={formatQuotesToBold(heroData?.heroS1Desc || "Converting data into foresight through ^decision intelligence^ that drives measurable business outcomes.") as any}
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            >
              ...
              <p className="text-[#11253e] text-lg md:text-xl font-light leading-relaxed">
                In a world defined by volatility and digital acceleration, competitive advantage belongs to organizations that convert data into foresight.
              </p>
            </Motion.div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="order-1 lg:order-2 space-y-12 p-5">
              <div className="space-y-4">
                ...
                <h3 className="text-[#f99d1c] text-xl font-bold uppercase tracking-widest">{formatQuotesToBold("Strategy-Led Decision Intelligence")}</h3>
              </div>

              <p className="text-[#11253e] text-lg font-light leading-relaxed">
                Analytics initiatives succeed when they are anchored in enterprise strategy. We begin by aligning analytics priorities with corporate objectives and regulatory discipline.
              </p>

              <div className="grid sm:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  "Enterprise KPI alignment across business functions",
                  "Executive visibility through real-time performance intelligence",
                  "Governance, privacy and regulatory discipline by design",
                  "Scalable architectures built for long-term evolution",
                  "Embedding analytics into core operational workflows"
                ].map((item, i) => (
              ...
              <p className="text-[#11253e] text-lg font-light leading-relaxed italic">
                {formatQuotesToBold("'Our focus is on decision intelligence that directly influences growth, operational resilience, and capital allocation.'")}
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-[#eeede9] relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-4xl mx-auto mb-24 space-y-6">
            ...
            <h3 className="text-[#11253e] text-xl font-light uppercase tracking-[0.2em]">{formatQuotesToBold("Disciplined Analytics Lifecycle")}</h3>
            <p className="text-[#11253e] text-lg font-light max-w-2xl mx-auto">
              {formatQuotesToBold("We follow a structured framework to deliver actionable insights that scale with your enterprise ambitions.")}
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-24 items-center">
            <div className="space-y-12 p-5">
              <div className="space-y-6">
                ...
                <h3 className="text-[#f99d1c] text-xl font-bold uppercase tracking-widest leading-snug">{formatQuotesToBold("Advanced Analytics Ecosystems.")}</h3>
              </div>

              <p className="text-[#11253e] text-lg font-light leading-relaxed">
                We integrate leading cloud-native data platforms, real-time analytics engines, and BI visualization systems to empower your decision-makers.
              </p>

              <div className="grid sm:grid-cols-2 gap-x-8 gap-y-6">
                {[
                  { icon: <Database size={18} />, text: "Cloud native data warehouses and lakehouses" },
                  { icon: <PieChart size={18} />, text: "Enterprise business intelligence & visualization" },
                  { icon: <Activity size={18} />, text: "Real-time streaming and event-driven analytics" },
                  { icon: <Brain size={18} />, text: "Advanced statistical modeling & machine learning" },
                  { icon: <Shield size={18} />, text: "Enterprise-grade governance & compliance controls" }
                ].map((item, i) => (
                  <div key={i} className="flex items-start space-x-3">
                    <CheckCircle2 className="text-[#f99d1c] shrink-0 mt-1" size={18} />
            ...
            <div className="relative">
              <div className="aspect-square bg-[#11253e] p-1 rounded-sm overflow-hidden shadow-2xl group">
                <ImageWithFallback 
                  ...
                  alt="Analytics Intelligence Platform"
              ...
              <div className="absolute -bottom-6 -left-6 bg-[#f99d1c] p-8 text-[#11253e] max-w-xs shadow-xl hidden md:block">
                <p className="text-sm font-medium italic">
                  {formatQuotesToBold("'Our analytics solutions turn complex enterprise data into intuitive, real-time executive dashboards.'")}
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-[#11253e] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-6">
            ...
            <h3 className="text-[#f99d1c] text-xl font-bold uppercase tracking-widest">{formatQuotesToBold("Foresight. Speed. Measurable ROI.")}</h3>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Accelerated Decision Cycles", desc: "Speed up executive and operational decision cycles with instant insights." },
              { title: "Performance Transparency", desc: "Gain enterprise-wide transparency across departments, products, and channels." },
              { title: "Forecasting Accuracy", desc: "Enhance financial and market forecasting accuracy with predictive models." },
              { title: "Regulatory Confidence", desc: "Strengthen governance, data privacy, and audit readiness by design." },
              { title: "AI-Ready Ecosystem", desc: "Build a scalable foundation for Machine Learning and intelligent automation." },
              { title: "Measurable Data ROI", desc: "Maximized return on investment across all enterprise data assets." }
            ].map((item, i) => (
              <Motion.div
                key={i}
          ...
          >
            ...
            <div className="max-w-xl space-y-4">
              <h2 className="text-[#11253e] text-3xl md:text-4xl font-bold tracking-tight leading-[1.2]">
                {formatQuotesToBold("Ready to transform data into \n^strategic advantage?^")}
              </h2>
              <p className="text-[#11253e] text-base font-light leading-relaxed">
                Let our experts design a decision intelligence strategy that scales with your ambition and delivers measurable value.
              </p>
            </div>
            <button
