...
export default function GovernmentPSU({ wordpressData }: { wordpressData?: any }) {
  ...
  const challenges = [
    ...
    {
      title: "Data Silos",
      text: "Fragmented data across agencies hindering unified decision-making and policy analysis.",
  ...
  const impactAreas = [
    {
      ...
      description: "We design secure digital platforms including e-governance portals, unified service delivery platforms, digital identity integrations and mobile-first citizen engagement systems that simplify access to public services.",
      details: ["E-Governance Portals", "Unified Service Delivery", "Digital Identity Integration"],
      icon: <Landmark size={40} />
    },
    {
      id: "data",
      title: "Data Integration & Smart Policy Intelligence",
      description: "We build enterprise data platforms that unify departmental data, enabling real-time insights for policy planning, program monitoring and outcome-based governance.",
      details: ["Unified Data Platforms", "Real-time Policy Insights", "Outcome-based Governance"],
      icon: <Database size={40} />
    },
    {
      id: "automation",
      title: "Intelligent Automation & Process Modernization",
      description: "We streamline workflows such as approvals, licensing, procurement, taxation, compliance tracking and grievance management through automation and AI-driven systems to reduce delays and increase transparency.",
      details: ["Workflow Automation", "AI-driven Compliance", "Grievance Management"],
      icon: <Zap size={40} />
    },
    {
      id: "infrastructure",
      title: "Smart Infrastructure & Public Sector Modernization",
      description: "We support digital transformation across utilities, transport, energy and public enterprises by enabling IoT integration, predictive maintenance and operational visibility.",
      details: ["IoT Integration", "Smart Utilities", "Predictive Maintenance"],
      icon: <Globe size={40} />
    },
    {
      id: "security",
      title: "Cybersecurity & Digital Resilience",
      description: "We strengthen cyber defenses, implement identity and access management frameworks and design resilient infrastructure to protect sensitive citizen and national data.",
      details: ["Zero-Trust Security", "Sovereign Data Protection", "Resilient Infrastructure"],
        ...
        <div className="max-w-7xl mx-auto px-6 w-full relative z-10">
          ...
          >
            <nav className="flex items-center space-x-3 text-[10px] uppercase tracking-[0.2em] text-white/40 mb-4 font-bold">
              ...
              <span className="w-1 h-1 rounded-full bg-[#f99d1c]"></span>
              <span className="text-[#f99d1c]">Government & PSUs</span>
            </nav>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            ...
            <p className="text-[#11253e] text-lg max-w-md text-right md:text-left">
              Digital maturity is now directly linked to public trust, economic development, and national competitiveness.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-[#11253e] text-xl max-w-3xl mx-auto">
              We help Governments and PSUs evolve into intelligent, connected, and resilient institutions.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              ...
              <p className="text-white/60 text-lg leading-relaxed max-w-md">
                We leverage secure and compliant cloud environments such as Amazon Web Services, Microsoft Azure, and Google Cloud to support government-grade scalability, security and compliance.
              </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {techCapabilities.map((cap, idx) => (
                <div key={idx} className="p-6 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                  <div className="text-[#f99d1c] mb-4">{cap.icon}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-[#11253e]">
            <div className="md:col-span-1">
              ...
              <p className="opacity-80 leading-relaxed">
                 We help Governments and PSUs evolve into intelligent, connected and resilient institutions where technology enhances citizen services, strengthens governance and drives sustainable national progress.
              </p>
            </div>
