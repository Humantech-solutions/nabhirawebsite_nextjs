  ...
  const challenges = [
    {
      ...
      icon: <ShoppingCart className="text-[#f99d1c]" size={32} />,
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div className="space-y-8">
              ...
              <p className="text-white/60 text-lg leading-relaxed max-w-md">
                We leverage secure and scalable cloud platforms such as Amazon Web Services, Microsoft Azure, and Google Cloud to power modern retail and CPG ecosystems.
              </p>
