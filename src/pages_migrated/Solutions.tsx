        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mb-16 lg:mb-24">
            <h2 className="text-3xl lg:text-5xl font-medium tracking-tight mb-8">
              {renderHeroTitle("Modular |Architectures|")}
            </h2>
            <p className="text-[#11253e] text-lg lg:text-xl leading-relaxed font-light">
              {formatQuotesToBold("We build solutions that aren't just software, but strategic assets that scale with your organization's ambition.")}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {products.map((product, idx) => (
              ...
              >
                ...
                <h3 className="text-2xl font-medium mb-4 group-hover:text-[#f99d1c] transition-colors">{formatQuotesToBold(product.title)}</h3>
      ...
      <section className="py-32 bg-[#11253e] text-white overflow-hidden relative">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center space-y-12 relative z-10">
          <h2 className="text-4xl lg:text-6xl font-medium tracking-tight">
            {renderHeroTitle(`Need a |Custom| Build?`)}
          </h2>
          <p className="text-white/60 text-xl font-light leading-relaxed max-w-2xl mx-auto">
            {formatQuotesToBold("Our engineering team specializes in architecting bespoke solutions for unique enterprise requirements. Let's build what's next.")}
          </p>
