...
export default function AIConsulting({ wordpressData }: { wordpressData?: any }) {
  ...
  return (
    <>
      {/* Hero Banner */}
      <section className="relative min-h-[450px] lg:min-h-[650px] bg-[#11253e] overflow-hidden flex items-center py-12 md:py-20">
              ...
              <div className="lg:col-span-5 w-full">
                ...
                >
                  ...
                  <div className="space-y-6">
                    {[
                      { value: "01", label: "AI Strategy & Roadmap", desc: "Architecting a multi-year AI vision that aligns with your business objectives and delivers measurable ROI." },
                      { value: "02", label: "LLM Implementation", desc: "Customizing and deploying Large Language Models for enterprise-specific use cases with precision and safety." },
                      { value: "03", label: "Data Readiness Audit", desc: "Evaluating your data ecosystem to ensure it is structured, clean, and ready to fuel high-performance AI models." }
                    ].map((stat, i) => (
