            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              >
                <div className="inline-flex items-center gap-4 bg-white/5 border border-white/10 px-6 py-2">
                  <Heart size={16} className="text-[#f99d1c]" />
                  <span className="text-white text-[10px] font-bold uppercase tracking-[0.4em]">Culture First Architecture</span>
                </div>
              ...
              <div className="hidden lg:block">
                <div className="relative p-12 bg-white/5 border border-white/10 backdrop-blur-sm">
