        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 grid grid-cols-1 lg:grid-cols-12 gap-16">
            ...
            <aside className="lg:col-span-1 flex lg:flex-col items-center lg:items-end gap-6 order-2 lg:order-1 lg:sticky lg:top-32 h-fit">
              <span className="hidden lg:block text-[10px] font-bold text-[#11253e]/20 uppercase tracking-[0.3em] vertical-text mb-4">Share Insights</span>
              <button className="p-3 rounded-full border border-gray-100 text-[#11253e]/60 hover:text-[#f99d1c] hover:border-[#f99d1c] transition-all cursor-pointer">
                <Twitter size={18} />
              </button>
              <button className="p-3 rounded-full border border-gray-100 text-[#11253e]/60 hover:text-[#f99d1c] hover:border-[#f99d1c] transition-all cursor-pointer">
                <Linkedin size={18} />
            ...
            <div className="lg:col-span-8 order-1 lg:order-2">
              <Motion.div 
                ...
                className="prose prose-lg max-w-none text-[#11253e]/70 font-light leading-relaxed blog-content"
