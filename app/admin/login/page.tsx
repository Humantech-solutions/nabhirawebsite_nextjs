    ...
    <div className="min-h-screen flex bg-white font-sans">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute bottom-12 left-12 z-10">
          <h2 className="text-4xl font-bold text-white mb-4 tracking-tight">Nabhira Admin</h2>
          <p className="text-white/80 max-w-md text-lg font-light leading-relaxed">
            Orchestrating digital evolution through advanced cloud ecosystems and autonomous AI platforms.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          {mfaStep === "login" ? (
            <>
              <div className="mb-10 text-center lg:text-left">
                <h1 className="text-3xl font-bold text-[#11253e] mb-2 tracking-tight">Welcome Back</h1>
                <p className="text-gray-500 font-medium font-bold">Please sign in to your admin account</p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      placeholder="admin@nabhira.com"
                      required
                      className="w-full pl-12 pr-4 py-4 bg-gray-100 border-2 border-gray-300 rounded-2xl text-[#11253e] font-bold placeholder-gray-400 focus:outline-none focus:border-[#f99d1c] focus:bg-white focus:ring-4 focus:ring-[#f99d1c]/10 transition-all text-[15px] font-sans shadow-sm"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      required
                      className="w-full pl-12 pr-12 py-4 bg-gray-100 border-2 border-gray-300 rounded-2xl text-[#11253e] font-bold placeholder-gray-400 focus:outline-none focus:border-[#f99d1c] focus:bg-white focus:ring-4 focus:ring-[#f99d1c]/10 transition-all text-[15px] font-mono shadow-sm"
                    />
                    <button
                      type="button"
          ...
          <div className="mt-20 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-100 pt-8">
            <p className="text-gray-400 text-[11px] tracking-[0.2em] uppercase font-bold">
              © {new Date().getFullYear()} Nabhira Technologies
            </p>
            <div className="flex gap-4">
              <span className="w-1.5 h-1.5 rounded-full bg-green-500 shadow-sm shadow-green-500/50" />
              <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider">MFA Protected</span>
            </div>
          </div>
        </div>
      </div>
